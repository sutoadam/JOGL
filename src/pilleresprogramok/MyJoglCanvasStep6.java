...
public class MyJoglCanvasStep6 extends GLCanvas implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
        	InputStream stream = new BufferedInputStream(new FileInputStream("/concept/works/graphics/demo/solar_panel_256x32.png"));
            TextureData data = TextureIO.newTextureData(gl.getGLProfile(), stream, false, "png");
    ...
    private void setCamera(GL gl2, GLU glu, float distance) {
        ...
        // glu.gluLookAt(0, satelliteAngle, 0, 0, 0, 0, 1, 0, 0);
